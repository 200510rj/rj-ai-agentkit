...
Explore the interactive HTML diagrams (with pan/zoom, dark/light themes, and animation trace):

- 🗺️ **[System Architecture & Component Map](docs/diagrams/system_architecture.html)** (`architecture` diagram)
- 🔀 **[Request Execution Workflow](docs/diagrams/pipeline_workflow.html)** (`workflow` diagram)
- 📡 **[Embedding RAG Sequence & Signal Trace](docs/diagrams/embedding_rag_sequence.html)** (`sequence` diagram)
- 🔄 **[Request State & Lifecycle Machine](docs/diagrams/request_lifecycle.html)** (`lifecycle` diagram)
